...
def load_textfiles(references, hypothesis):
    ...
    raw_refs = [list(map(str.strip, r)) for r in zip(references)] # [sa,sb,sc] -> [[sa],[sb],[sc]]
...
# XXX (main function to call)
def score(ref, hypo):
    """ the ref is ground_truth, hypo is the output of model
        hypy is (id, [sent])
        ref  is (id, [ref1, ref2, ref3...])
    ...
    return final_scores # {method_str, score}
